...
public class LoadGame implements Screen {
    ...
    public void show() {
        ...
        save1 = new TextButton("Load save 1", but_skin);
        save2 = new TextButton("Load save 2", but_skin);
        save3 = new TextButton("Load save 3", but_skin);
        save4 = new TextButton("Load save 4", but_skin);
